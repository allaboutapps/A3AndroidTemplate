...
object Dependencies {
    const val AndroidXAnnotations = "androidx.annotation:annotation:1.4.0-alpha02"
    const val AndroidXAppCompat = "androidx.appcompat:appcompat:1.6.0-alpha01"
    const val AndroidXBiometric = "androidx.biometric:biometric:1.2.0-alpha04"
    const val AndroidXCoreKtx = "androidx.core:core-ktx:1.9.0-alpha01"
    const val AndroidXMultiDex = "androidx.multidex:multidex:2.0.1"
    const val AndroidXRecyclerView = "androidx.recyclerview:recyclerview:1.3.0-alpha01"
    const val AndroidXCardView = "androidx.cardview:cardview:1.0.0"
    const val AndroidXConstraintLayout = "androidx.constraintlayout:constraintlayout:2.1.3"
    ...
    // Firebase
    const val FirebaseMessaging = "com.google.firebase:firebase-messaging:23.0.0"
    const val FirebaseAnalytics = "com.google.firebase:firebase-analytics-ktx:20.1.0"
    const val FirebaseCrashlytics = "com.google.firebase:firebase-crashlytics:18.2.8"

    // Play Services
    const val PlayServicesMaps = "com.google.android.gms:play-services-location:19.0.1"
    ...
    const val MaterialComponents = "com.google.android.material:material:1.6.0-alpha03"
